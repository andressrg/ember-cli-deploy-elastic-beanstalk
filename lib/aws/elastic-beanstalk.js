...
function ElasticBeanstalk(options) {
  ...
  if (options && options.accessKeyId) {
    awsConfig.accessKeyId = options.accessKeyId;
  }
  if (options && options.secretAccessKey) {
    awsConfig.secretAccessKey = options.secretAccessKey;
  }
  this.eb = new AWS.ElasticBeanstalk(awsConfig);
}
